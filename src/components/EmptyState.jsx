...
const STEPS = [
  {
    num: '1',
    title: 'Verify the automation is active',
    body: 'Go to admin.happierleads.com → Automations and confirm your automation is set to Active (not Paused). The webhook endpoint is already configured:',
    code: 'https://happier-leads-automation.vercel.app/api/webhook/happierleads',
    note: 'The automation must be Active for webhooks to fire. No ngrok or local setup is needed.',
  },
  {
    num: '2',
    title: 'Check the filter is set to "All Leads"',
    body: 'Inside the automation, confirm the filter is set to All Leads so both Exact and Suggested visitors are captured.',
    code: null,
    note: null,
  },
  {
    ...
    body: 'Browse your tracked website from a different network or device. Happier Leads will identify the visitor and fire the webhook here within seconds.',
    code: null,
    note: null,
  },
];
