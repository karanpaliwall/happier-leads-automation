    ...
    >
      {!collapsed && (
        <div className="sidebar-brand">
          ...
          {open && (
            <button className="sidebar-close-btn" onClick={(e) => { e.stopPropagation(); onClose(); }} aria-label="Close menu">
      ...
      <nav className="sidebar-nav" onClick={(e) => collapsed && e.stopPropagation()}>
